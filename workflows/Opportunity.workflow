...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>Email_Donor_Tax_Letter</fullName>
        <description>Email Donor Tax Letter</description>
        ...
        <template>unfiled$public/Single_Donation_Thank_You_Letter</template>
    </alerts>
    <alerts>
        <fullName>Email_Leadership_Donation_Over_500</fullName>
        <description>Email Leadership Donation Over $500</description>
        <protected>false</protected>
        <recipients>
            <recipient>pcampanelli@therootsofmusic.org</recipient>
            <type>user</type>
        </recipients>
        <recipients>
            <recipient>sfdcadmin@salesforce.test</recipient>
            <type>user</type>
        </recipients>
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/Donations_over_500</template>
    </alerts>
    <alerts>
